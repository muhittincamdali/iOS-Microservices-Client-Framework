...
- `feature/service-discovery-enhancement`
- `bugfix/load-balancing-issue`
- `docs/api-documentation`
- `test/microservices-coverage`
...
Examples:
- `feat(discovery): add health check support`
- `fix(balancer): resolve memory leak in connection pool`
...
```swift
func testServiceDiscoveryDiscoversAvailableServices()
func testLoadBalancingSelectsOptimalService()
func testCircuitBreakerOpensOnFailureThreshold()
```
